...
<div class="site-about">
    ...
    <p class="about-para">
        ...
        Majmua, the serch engine, solves this problem.
        <br><br>&emsp;
        Majmua aims to provide results that are free from innovations and corruptions.
    </p>
    <br>
    ...
    <p class="about-para">
        ...
        The best way to help woulfd be by using Majmua and reporting erratic articles, media
        and also erratic behaviour.
        If you are a developer and are willing to help with development, head over to github.
        InshAllah with time, I intend to involve others and improve Majmua.
